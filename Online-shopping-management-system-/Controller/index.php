...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container" id="nav">
      <div class="logo">
        <img src="../View/image/logo-online-shop-png-3.png" alt="">
      </div>
      <div class="bar_1">
        <div class="search">
      ...
      <div class="contact">
        <h1>Get In Touch</h1>
          ...
          <div class="col-md-6 contact-info" data-aos="fade-down" data-aos-duration="2000">
            ...
            <div class="folow">
              <b>Phone:</b><i class="fa fa-phone"></i> +880 1861367136
            </div>
          <div class="folow">
            <b>Email:</b><i class="fa fa-envelope-o"></i> doladola9400@gmail.com
          </div>
        </div>
    </section>
    <section id="foot">
